...
class Habit(Model):
    ...
    is_published = BooleanField(default=True, verbose_name="Признак публичности",
        help_text="Если отмечено, привычка будет видна другим пользователям")
    owner = ForeignKey(AUTH_USER_MODEL, on_delete=CASCADE, null=True, blank=True, verbose_name="Создатель привычки",
